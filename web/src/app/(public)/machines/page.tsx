            ...
            >
              ...
              <div className="space-y-2 mt-4 pt-4 border-t border-slate-800/80 text-xs font-mono">
                <div className="flex justify-between">
                  ...
                  <span className="text-slate-200">{mac.PowerConsumption}W</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-400">Max Temp Threshold:</span>
                  <span className="text-red-400">{mac.MaxTemperature}°C</span>
                </div>
              </div>
            </div>
          ))}
